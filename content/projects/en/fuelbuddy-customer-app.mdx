...
description: Migrated FuelBuddy's customer app from a PWA to React Native after iOS made web apps unworkable on iPhone, shipping features across the stack.
