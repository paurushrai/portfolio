...
description: Built end-to-end features for FuelBuddy's driver app — offline-tolerant workflows, live location tracking, a field-ready UI, and the CRUD APIs behind them on Hasura GraphQL.
