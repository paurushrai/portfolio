...
description: The portfolio site itself — a Next.js 14 build with 12-language support, a first-party analytics proxy that survives ad blockers, and a 99/100 Lighthouse score. Open source.
