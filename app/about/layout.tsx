...
export const metadata: Metadata = {
  ...
  description: "Meet Paurush Rai — Senior Software Engineer with 5+ years building enterprise SaaS, AI-integrated platforms, and developer tools using React, Next.js, TypeScript, and Node.js. Based in India.",
  keywords: [
