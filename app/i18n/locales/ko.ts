...
export const ko: Locale = {
  ...
  blogs: {
    title: "블로그",
    subtitle: "엔지니어링, 도구, 그리고 오래 가는 것을 만드는 방법에 대한 글.",
    empty: "아직 게시물이 없습니다, 곧 다시 확인해 주세요.",
    minRead: "분 읽기",
    moreTitle: "블로그 더 보기",
    viewAll: "전체 보기",
  },
    ...
    experience: [
      {
        ...
        period: "2025년 1월 – 현재",
        highlights: [
          "11,000+ 페이지 규모의 마케팅 사이트에서 WordPress를 Jamstack으로 교체하는 아키텍처 결정을 주도하여, 더 빠른 콘텐츠 전송을 통해 페이지 로딩 시간을 단축하고 이탈률을 낮추는 것을 목표로 했습니다.",
          ...
          "Git 브랜치 컨텍스트에서 Jira 티켓을 감지하여 Appforest로의 시간표 입력을 자동화하는 VS Code 확장을 개발하여 수동 추적 작업을 줄였습니다.",
          "4개 애플리케이션에서 공유되는 무상태 컴포넌트 라이브러리를 도입하고 비공개 npm 패키지로 배포하여 앱별 UI 중복을 제거했습니다."
        ]
      },
      {
        company: "FuelBuddy",
        ...
        highlights: [
          "새로운 급유 하드웨어를 위한 키오스크 앱을 처음부터 구축하여 50대 이상의 급유 트럭에 배포하고, 실시간 IoT 데이터를 통해 일일 1,000건 이상의 거래를 처리하며 배송 계산과 인보이스 발행을 자동화했습니다.",
          "프로그레시브 웹 앱을 React Native로 마이그레이션하여 8주 만에 14개 사용자 플로우에서 100% 기능 동등성을 달성했습니다.",
          "5개 제품에 걸쳐 TanStack Query를 표준화하여 4개 프론트엔드 팀을 통합된 서버 상태 아키텍처로 정렬하고 오래된 데이터 결함을 제거했습니다.",
          "단위 테스트를 위한 Vitest와 E2E 테스트를 위한 Playwright를 도입하여 16,000개 이상의 테스트 케이스를 자동화하고 릴리스당 수동 QA 작업을 줄였습니다.",
          "코드 리뷰, 페어 프로그래밍, 온보딩 지원을 통해 8명의 엔지니어를 멘토링하여 팀 전반의 빠른 적응과 탄탄한 코딩 표준을 이끌었습니다."
        ]
      },
      {
        company: "Modocosm",
        ...
        highlights: [
          "Directus의 스키마 쓰기 동작을 리버스 엔지니어링하고 수동 UI 설정을 SQL 스크립트로 대체하여 스키마 설정 시간을 3시간에서 5분으로 단축했습니다.",
          "뉴스 미디어 고객을 위해 플랫폼 간 동영상 성과 추적을 자동화하는 소셜 분석 대시보드를 개발하여 주당 15개 이상의 수동 스프레드시트 보고서를 없앴습니다.",
          "Astro.js와 Directus CMS로 7개의 레거시 웹사이트를 현대화하여 콘텐츠 게시 속도를 두 배로 높였습니다.",
