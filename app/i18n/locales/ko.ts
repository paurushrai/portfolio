...
export const ko: Locale = {
  ...
  about: {
    ...
    bio: [
      "저는 Paurush Rai입니다. 인도에 본사를 둔 프런트엔드 지향 풀스택 엔지니어로 엔터프라이즈 웹 플랫폼, AI 기반 애플리케이션 및 개발자 생산성 도구를 설계한 5년 이상의 경력을 보유하고 있습니다. 내 작업은 복잡한 B2B 대시보드, 강력한 LMS 통합, 사용자 정의 Jira 및 VS Code 플러그인, 그리고 그 사이의 모든 것을 포괄합니다.",
    ...
    experience: [
      {
        ...
        highlights: [
          ...
          "6개 이상의 Testlify 리포지토리에 도입된 비공개 npm 컴포넌트 라이브러리를 배포하여 중복 UI 코드를 제거하고 기능 출시를 30% 단축했습니다.",
